               ...
               {ftxui::window(
                    ...
                    ftxui::vbox({
                        ...
                        Tetris::Renderer::KeyValue::create(
                            "Soft drop delay",
                            this->softDropDelayTicks * this->config.updatesPerSecond),
                        Tetris::Renderer::KeyValue::create(
                            "Store delay",
                            this->storeDelayTicks * this->config.updatesPerSecond),
                        Tetris::Renderer::KeyValue::create(
                            "Combo delay",
                            this->comboDelayTicks * this->config.updatesPerSecond),
                    })),
                ftxui::window(
                    ftxui::text("Render"),
                    ftxui::vbox(
